...
static const device_register_mapping_t inverter1_mapping_table[] = {
    ...
    { 0x0000,  0x0000,  ACCESS_RO,  "INV1_Device_Status"              },
    { 0x0001,  0x0001,  ACCESS_RO,  "INV1_Fault_Code"                 },
    { 0x0002,  0x0002,  ACCESS_RO,  "INV1_Warning_Code"               },

    /* ── AC output measurements ─────────────────────────────────────────── */
    { 0x0010,  0x0003,  ACCESS_RO,  "INV1_AC_Output_Voltage"          },
    { 0x0011,  0x0004,  ACCESS_RO,  "INV1_AC_Output_Current"          },
    { 0x0012,  0x0005,  ACCESS_RO,  "INV1_AC_Output_Frequency"        },
    { 0x0013,  0x0006,  ACCESS_RO,  "INV1_AC_Output_Active_Power"     },
    { 0x0014,  0x0007,  ACCESS_RO,  "INV1_AC_Output_Apparent_Power"   },
    { 0x0015,  0x0008,  ACCESS_RO,  "INV1_AC_Output_Load_Percent"     },

    /* ── AC input / grid measurements ──────────────────────────────────── */
    { 0x0020,  0x0009,  ACCESS_RO,  "INV1_Grid_Voltage"               },
    { 0x0021,  0x000A,  ACCESS_RO,  "INV1_Grid_Frequency"             },

    /* ── DC bus / PV input ──────────────────────────────────────────────── */
    { 0x0030,  0x000B,  ACCESS_RO,  "INV1_PV_Input_Voltage"           },
    { 0x0031,  0x000C,  ACCESS_RO,  "INV1_PV_Input_Current"           },
    { 0x0032,  0x000D,  ACCESS_RO,  "INV1_PV_Input_Power"             },
    { 0x0033,  0x000E,  ACCESS_RO,  "INV1_DC_Bus_Voltage"             },

    /* ── Battery measurements ───────────────────────────────────────────── */
    { 0x0040,  0x000F,  ACCESS_RO,  "INV1_Battery_Voltage"            },
    { 0x0041,  0x0010,  ACCESS_RO,  "INV1_Battery_Current"            },
    { 0x0042,  0x0011,  ACCESS_RO,  "INV1_Battery_State_of_Charge"    },
    { 0x0043,  0x0012,  ACCESS_RO,  "INV1_Battery_Temperature"        },
    { 0x0044,  0x0013,  ACCESS_RO,  "INV1_Battery_Charge_Mode"        },

    /* ── Temperature ────────────────────────────────────────────────────── */
    { 0x0050,  0x0014,  ACCESS_RO,  "INV1_Heatsink_Temperature"       },
    { 0x0051,  0x0015,  ACCESS_RO,  "INV1_Transformer_Temperature"    },

    /* ── Energy counters ────────────────────────────────────────────────── */
    { 0x0060,  0x0016,  ACCESS_RO,  "INV1_Total_Output_Energy_Lo"     },
    { 0x0061,  0x0017,  ACCESS_RO,  "INV1_Total_Output_Energy_Hi"     },
    { 0x0062,  0x0018,  ACCESS_RO,  "INV1_Total_PV_Energy_Lo"         },
    { 0x0063,  0x0019,  ACCESS_RO,  "INV1_Total_PV_Energy_Hi"         },

    /* ── Configuration (read/write) ─────────────────────────────────────── */
    { 0x0100,  0x001A,  ACCESS_RW,  "INV1_Output_Voltage_Set"         },
    { 0x0101,  0x001B,  ACCESS_RW,  "INV1_Output_Frequency_Set"       },
    { 0x0102,  0x001C,  ACCESS_RW,  "INV1_Battery_Low_Voltage_Set"    },
    { 0x0103,  0x001D,  ACCESS_RW,  "INV1_Battery_High_Voltage_Set"   },
    { 0x0104,  0x001E,  ACCESS_RW,  "INV1_Max_Charge_Current_Set"     },
    { 0x0105,  0x001F,  ACCESS_RW,  "INV1_Work_Mode_Set"              },
};
